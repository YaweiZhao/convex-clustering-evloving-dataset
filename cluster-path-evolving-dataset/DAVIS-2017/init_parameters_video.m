function [s_hyp] = init_parameters_video(s_hyp)
...
%build network
s_hyp = build_network_video(s_hyp);
s_hyp = build_Q_no_alpha_video(s_hyp);
...
s_hyp.alpha = 2; %hyper-parameter for regularized item, 10 in default
s_hyp.num_level = 4;
